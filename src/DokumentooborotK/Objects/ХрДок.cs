...
namespace IIS.DokumentooborotK
{
    ...
    public class ХрДок : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.DokumentooborotK.DetailArrayOfТЧСоздДок fТЧСоздДок;
        
        private IIS.DokumentooborotK.DetailArrayOfТЧУтвержДок fТЧУтвержДок;
        ...
        public virtual IIS.DokumentooborotK.DetailArrayOfТЧСоздДок ТЧСоздДок
        {
            get
            {
                ...
                {
                    this.fТЧСоздДок = new IIS.DokumentooborotK.DetailArrayOfТЧСоздДок(this);
                }
                IIS.DokumentooborotK.DetailArrayOfТЧСоздДок result = this.fТЧСоздДок;
        ...
        public virtual IIS.DokumentooborotK.DetailArrayOfТЧУтвержДок ТЧУтвержДок
        {
            get
            {
                ...
                {
                    this.fТЧУтвержДок = new IIS.DokumentooborotK.DetailArrayOfТЧУтвержДок(this);
                }
                IIS.DokumentooborotK.DetailArrayOfТЧУтвержДок result = this.fТЧУтвержДок;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ХрДокE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ХрДокE", typeof(IIS.DokumentooborotK.ХрДок));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ХрДокL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ХрДокL", typeof(IIS.DokumentooborotK.ХрДок));
                }
            }
        }
    }

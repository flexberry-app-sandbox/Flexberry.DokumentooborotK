...
CREATE TABLE [ТЧУтвержДок] (
	 ...
	 [РасДок] UNIQUEIDENTIFIER  NOT NULL,

	 [ХрДок] UNIQUEIDENTIFIER  NOT NULL,
...
CREATE TABLE [ТЧСоздДок] (
	 ...
	 [ФормаДокумента] UNIQUEIDENTIFIER  NOT NULL,
...
CREATE TABLE [ТЧПрава] (
	 ...
	 [АвПользователи] UNIQUEIDENTIFIER  NOT NULL,
...
CREATE TABLE [ТЧПользователь] (
	 ...
	 [ВходВСистему] UNIQUEIDENTIFIER  NOT NULL,
